...
plugins {
    ...
    // graphql plugins
    id("com.expediagroup.graphql") version "8.6.1"
...
dependencies {
    implementation("com.expediagroup:graphql-kotlin-spring-server:8.6.1")
    implementation("org.jetbrains.kotlin:kotlin-reflect")

    testImplementation("com.expediagroup:graphql-kotlin-spring-client:8.6.1")
    testImplementation("org.jetbrains.kotlin:kotlin-test")
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.10.2")
    testImplementation("org.springframework.boot:spring-boot-starter-test:3.3.6")

    graphqlSDL("com.expediagroup:graphql-kotlin-federated-hooks-provider:8.6.1")
}
