...
dependencies {
    implementation("com.expediagroup:graphql-kotlin-spring-server:6.5.1")
    implementation("org.jetbrains.kotlin:kotlin-reflect")
    implementation("org.jetbrains.kotlin:kotlin-stdlib-jdk8")

    testImplementation("com.expediagroup:graphql-kotlin-spring-client:6.5.1")
    testImplementation("org.jetbrains.kotlin:kotlin-test")
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.7.1")
    testImplementation("org.springframework.boot:spring-boot-starter-test:2.7.12")

    graphqlSDL("com.expediagroup:graphql-kotlin-federated-hooks-provider:6.5.1")
}
