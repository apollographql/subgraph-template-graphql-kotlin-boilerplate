...
dependencies {
    implementation("com.expediagroup:graphql-kotlin-spring-server:9.1.0")
    implementation("org.jetbrains.kotlin:kotlin-reflect")

    testImplementation("com.expediagroup:graphql-kotlin-spring-client:9.1.0")
    testImplementation("org.jetbrains.kotlin:kotlin-test")
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.10.2")
    testImplementation("org.springframework.boot:spring-boot-starter-test:3.5.13")

    graphqlSDL("com.expediagroup:graphql-kotlin-federated-hooks-provider:9.1.0")
}
