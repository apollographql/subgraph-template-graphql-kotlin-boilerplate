...
dependencies {
    implementation("com.expediagroup:graphql-kotlin-spring-server:7.1.5")
    implementation("org.jetbrains.kotlin:kotlin-reflect")

    testImplementation("com.expediagroup:graphql-kotlin-spring-client:7.1.5")
    testImplementation("org.jetbrains.kotlin:kotlin-test")
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.8.1")
    testImplementation("org.springframework.boot:spring-boot-starter-test:3.1.5")

    graphqlSDL("com.expediagroup:graphql-kotlin-federated-hooks-provider:7.1.5")
}
